...
export async function emailBroadcast(id) {
  ...
  if (reservation) {
    ...
    if (reservation.reservationState === 'pending') {
      ...
      sendEmail(hostEmail, 'bookingRequest', contentForHost);
      ...
      sendEmail(guestEmail, 'bookingRequestGuest', contentForguest);
    }
    ...
    if (reservation.reservationState === 'approved') {
      ...
      sendEmail(hostEmail, 'bookingConfirmedToHost', contentForHost);
      ...
      sendEmail(guestEmail, 'bookingConfirmedToGuest', contentForguest);
    }
    return {
