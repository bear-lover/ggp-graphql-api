...
const privileges = [
    ...
    {
        id: 20,
        privilege: 'Manage Cofiguration Settings',
        permittedUrls: [
            '/siteadmin/settings/siteConfiguration'
        ]
    },
    {
        id: 21,
        privilege: 'Cancellation Policy Management',
        permittedUrls: [
            '/siteadmin/cancellation-policies/management'
        ]
    },
    {
        id: 22,
        privilege: 'Manage Why Host Page',
        permittedUrls: [
            '/siteadmin/why-host'
        ]
    },
