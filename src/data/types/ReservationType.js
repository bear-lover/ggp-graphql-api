    ...
    fields: {
        ...
        checkIn: {
            ...
            async resolve(reservation) {
                return reservation && reservation.checkIn ? moment.utc(`${reservation.checkIn} 12:00`).valueOf() : ""
            }
        },
        checkOut: {
            type: StringType,
            async resolve(reservation) {
                return reservation && reservation.checkOut ? moment.utc(`${reservation.checkOut} 12:00`).valueOf() : ""
            }
        },
        guests: {
            type: IntType
