        ...
        try {
            if (request.user) {
                ...
                if (getUser) {
                    ...
                    const { userStatusErrorMessage, userStatusError } = await checkUserBanStatus(userId); // Check user ban or deleted status
                    ...
                    if (createNewToken) {
                        ...
                        const { status, errorMessage } = sendEmail(email, 'forgotPasswordLink', content);
